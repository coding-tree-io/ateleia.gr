...
export function Resources() {
  ...
  return (
    <section id="resources" ref={ref} className="reveal relative overflow-hidden px-6 py-20 md:px-10 md:py-28">
      <ParallaxLayer speed={0.18} className="absolute -left-20 bottom-[-12%] w-[620px]">
        <DancingFigures />
      </ParallaxLayer>
      <ParallaxLayer speed={0.25} className="absolute right-[8%] top-[8%] hidden w-24 md:block">
        <HandCircle />
      </ParallaxLayer>
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((item) => (
            <a
              ...
              className="group paper-panel flex flex-col justify-between rounded-2xl border border-border/45 p-6 transition-all duration-500 hover:-translate-y-1.5 hover:shadow-lg"
            >
              <div>
